...
class Philosophie extends React.Component {
  render () {
    return(
      <React.Fragment>
<>
      <div className="pa2 pv5 flex-wrap serif" style={{width:'80%', marginLeft:'auto', marginRight:'auto', marginTop:'-30px'}}><h3 className ="subh2">Philosophie</h3>
      <div style={{display:'flex'}} className="konzept">
...
Bauabschnitt auch Räume im Objekt beziehen. Somit arbeiten die Therapeuten und
Pfleger Hand in Hand zum <br /><b>Wohle unserer künftigen Bewohner</b>.
        </div>
        <div className="right">
        </div>
        </div>
